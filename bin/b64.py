...
class B64Command(StreamingCommand):
    ...
    .. code-block::
        base64 entity=my_entity field=input
    ...
    *** Method-level stuff ***
    ...
    self.logger.debug('B64Command: %s', self)
    ...
    *** Runtime / testing ***
    ...
    Enable debug logging:
        ...
        ... | base64 logging_level=DEBUG ...

    """

    def __init__(self):
        super(B64Command, self).__init__()
        # COOKIECUTTER-TODO: initialize any custom variables in __init__()

    def prepare(self):
        super(B64Command, self).prepare()
    ...
    def _query_external_api(self, query_string):
        # COOKIECUTTER-TODO: Implement remote Base64 API query here
        """ Handle the query to Base64 API that drives this SPL command
        ...
        try:
            ...
            return ("Base64 Connection failure:  {}".format(e), [])
        except Exception:
            self.logger.exception("Failure while calling API")
            return ("Base64 API Call failed", [])
